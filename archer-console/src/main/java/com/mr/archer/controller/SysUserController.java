...
public class SysUserController extends BaseController {
  ...
  @PermInfo("查询用户列表信息（排除当前用户）")
  @PostMapping("/alllist")
  public Json allList(@RequestBody String body) {
    String oper = "query user alllist";
    ...
    String sNick = filterJson.getString("nick");
    Page<SysUser> listdata = userService.selectAllUserList(PageUtils.getPageParam(json), sCurUserId, sNick);

    return Json.succ(oper).data("data", listdata);
  }
